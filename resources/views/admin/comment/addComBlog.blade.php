            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    {{-- kiểm tra xem có tồn tại lỗi không rồi in ra --}}
                        ...
                        <form action="{{ url('admin/comment-blog/add') }}" method="POST">
                            <div class="form-group">
                                <label>User</label>
                                <select class="form-control" name="User">
                                @foreach ($user as $ur)
                                    <option @if(old('User')==$ur->id) {!! "selected" !!} @endif value="{!! $ur->id !!} ">
                                        {!! $ur->name !!}
                                    </option>
                                @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                @foreach ($blog as $bl)
                                    <option @if(old('Blog')==$bl->id) {!! "selected" !!} @endif value="{!! $bl->id !!} ">
                                        {!! $bl->tieude !!}
                                    </option>
                                @endforeach
                                </select>
